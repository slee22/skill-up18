...
public class DeviceDetailActivity_ extends AppCompatActivity {
    ...
    protected static DeviceDetailActivity_ mThis = null;
...
//        startBLEService();
    ...
    public static DeviceDetailActivity_ getInstance() {
        return (DeviceDetailActivity_) mThis;
    }


    private void initialProgressBar(){
        progressDialog = new ProgressDialog(DeviceDetailActivity_.this);
